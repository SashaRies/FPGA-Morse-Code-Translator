...
set_property PACKAGE_PIN U16 [get_ports {morse_out_port}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {morse_out_port}]
# LED 1
#set_property PACKAGE_PIN E19 [get_ports {lights_ext_port[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lights_ext_port[4]}]
# LED 2
#set_property PACKAGE_PIN U19 [get_ports {lights_ext_port[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lights_ext_port[3]}]
## LED 3
...
# LED 13
#set_property PACKAGE_PIN N3 [get_ports {lights_ext_port[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lights_ext_port[2]}]
# LED 14
#set_property PACKAGE_PIN P1 [get_ports {lights_ext_port[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lights_ext_port[1]}]
# LED 15 (LEFT MOST LED)
#set_property PACKAGE_PIN L1 [get_ports {lights_ext_port[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lights_ext_port[0]}]
...
##====================================================================
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {morse_freq_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {morse_freq_out}]
##Sch name = JA2
...
#set_property PACKAGE_PIN A18 [get_ports serial_out_data_port]						
	#set_property IOSTANDARD LVCMOS33 [get_ports serial_out_data_port]
